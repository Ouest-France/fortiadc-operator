...
import (
	...
	"github.com/Ouest-France/fortiadc-operator/controllers"
...
func init() {
	...
	_ = fortiadcv1.AddToScheme(scheme)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "93704884.ouest-france.fr",
	})
	if err != nil {
	...
	if err = (&controllers.RealServerReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("RealServer"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "RealServer")
		os.Exit(1)
	}
